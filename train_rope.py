...
from experimentation.RoPE.model_rope import GPTConfig, GPT
...
init_from = 'scratch' # 'scratch' or 'resume' not using gpt2 since it does not have rope implementation
# wandb logging
...
exec(open('config/train_shakespeare_char_rope.py').read()) # overrides from command line or config file
